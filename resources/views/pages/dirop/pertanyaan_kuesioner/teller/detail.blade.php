...
@section('content')
 <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Detail Pertanyaan Kuesioner Teller</h1>
...
<div class="card shadow">
    <div class="card-body">
            ...
            <div class="form-group">
             ...
             <button type="submit" onclick="location.href='{{route ('kuesionerteller.index')}}'" class="btn btn-primary btn-block">Kembali</button> 
