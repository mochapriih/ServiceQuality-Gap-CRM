...
@section('content')
 <!-- Page Heading -->
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ubah Pertanyaan Kuesioner Kredit</h1>
...
<div class="card shadow">
    <div class="card-body">
        <form action="{{ route('kuesionerkredit.update', $item->id) }}" method="post" enctype="multipart/form-data">
            @method('PUT')
            @csrf
