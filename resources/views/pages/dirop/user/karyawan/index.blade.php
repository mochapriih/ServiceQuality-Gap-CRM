...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{route ('datakaryawan.create')}}" class="btn btn-sn btn-primary shadow-sm">
        <i class="fas fa-plus fa-sm text-white-50"></i>Tambah Karyawan
    </a>
    
</div>
<div class="row">
    <form method="GET" action="/dirop/datakaryawan"
            ...
            <table class="table table-bordered" width="100%" cellspacing="0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $item->jabatan}}</td>
                        <td>
                            <a href="{{ route('datakaryawan.show', $item->id) }}" class="btn btn-info">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('datakaryawan.edit', $item->id) }}" class="btn btn-info">
                                <i class="fa fa-pencil-alt"></i>
                            </a>
                            <form action="{{ route('datakaryawan.destroy', $item->id) }}" method="POST"
                                class="d-inline">
                                @csrf
                                @method('delete')
