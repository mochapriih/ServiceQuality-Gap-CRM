...
class HasilKreditController extends Controller
{
    /**
    ...
    {
        $pertanyaans = PertanyaanKuesioner::where('kategori_kuesioner', 'KREDIT')->paginate(20);
        ...
        return view('pages.dirop.jawaban_kuesioner.kredit.result',[
