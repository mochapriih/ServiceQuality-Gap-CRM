...
class HasilCsController extends Controller
{
    /**
    ...
    {
        $pertanyaans = PertanyaanKuesioner::where('kategori_kuesioner', 'CUSTOMER SERVICE')->paginate(20);
        ...
        // return view('pages.dirop.jawaban_kuesioner.cs.result', 
        // compact('hitunggap', 'pertanyaans', 'tekshasil'));
