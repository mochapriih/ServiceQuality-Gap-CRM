...
class JawabanTellerController extends Controller
{
    /**
    ...
    {
        $items = PertanyaanKuesioner::Where('kategori_kuesioner', 'TELLER')->get();

        return view('pages.nasabah.kuesioner.teller.index',[
            'items' => $items
        ]);
    }
